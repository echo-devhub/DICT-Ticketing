...
<form method="post" class="form_ticket" id="form_create_ticket">
    ...
    <div class="field mb-3 textarea position-relative">
        ...
        <textarea name="description" id="description" cols="30" rows="15" class="form-control"><?php echo $ticket->get_input('name'); ?></textarea>
    ...
    <!-- image preview -->
    <div id="img_preview" class="m-3 position-relative"></div>
