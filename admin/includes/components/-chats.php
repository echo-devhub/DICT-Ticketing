 <?php foreach ($chats as $chat) : ?>
     ...
     <?php if ($chat['sender_id'] == $currentUser['agent_id']) : ?>
         ...
         <?php if (!empty($chat['image_chat']) && !empty($chat['text_chat'])) : ?>
             ...
             <div class="d-flex flex-column ms-auto p-1 mb-3 me-2">
                 <div class="chat_img mb-1 rounded overflow-hidden ms-auto" onclick="showImage(this)">
                     <img src="../assets/media/photos/messaging/<?php echo $chat['image_chat']; ?>" alt="" id="img">
                 </div>
             ...
             <div class="d-flex flex-column mb-3 me-auto">
                 ...
                 <div class="d-flex">
                     <div class="avatar align-self-end">
                         <img src="../assets/media/photos/built_in/avatar.png" alt="img" />
                     </div>
